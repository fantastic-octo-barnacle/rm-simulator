...
impl Default for LayoutOptions {
    ...
    /// referee and spent-ball retirement.
    fn default() -> Self {
        Self {
            rune: None,
...
///
/// The simulation always runs on the fixed 128 Hz tick from
/// [`rm_simulator_world::tick_ns`], so there is no rate to freeze here.
///
