...
"""Run frozen T3 blocks in independent processes, after all compilation finishes."""
import argparse
...
def main():
    ...
    def block(spec):
        ...
        environment = dict(os.environ, RM_NET_CODEC="zstd-dict", RM_NET_ZSTD_LEVEL="3", RM_NET_DEFLATE_LEVEL="1", RM_SECTION_T3_PLAYERS=str(players), RM_SECTION_T3_PROFILE=profile)
