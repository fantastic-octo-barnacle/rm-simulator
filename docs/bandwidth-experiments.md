...
deflate follow-up (historical; DEFLATE is gone) measured 64 ms world checkpoints
with 32 ms owner updates and a separate selected-stream deflate 1/4 sweep; neither
was enabled and constrained-link acceptance failed. A later ZSTD dictionary
experiment, then behind a selectable wire codec, measured a 30–58% cut of the
selected stream and became the production codec in protocol 35.
